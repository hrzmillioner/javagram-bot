...
import com.jpomykala.javagram.core.request.payload.InstagramSearchLocationsResult;
...
public class InstagramSearchLocationsRequest extends InstagramGetRequest<InstagramSearchLocationsResult>
{
  ...
  {
    return "location_search/?ig_sig_key_version=" + ApiConstants.API_KEY_VERSION
            + "&search_query=" + query
